...
DEFAULT_REPORT_PATH = ROOT / "homepage_link_recovery_report.json"
DEFAULT_SOURCE_PATH = ROOT / "transformed_resources.json"
DEFAULT_MAPPING_PATH = ROOT / "modx_to_strapi.json"
DEFAULT_EXCEPTIONS_PATH = ROOT / "homepage_link_exceptions.json"
