...
| `cn` | `frontend/src/lib/utils.ts` | Tailwind class-name merge utility (`clsx` + `tailwind-merge`) |

## Related

- [sections-module.md](sections-module.md) — SectionRenderer which delegates to these components
- [page-layouts-module.md](page-layouts-module.md) — page-shape components consuming design-system primitives
