...
from cms_audit import CHECKPOINT_SOURCE_DIR, MODX_SOURCE_DIR, ROOT

def verify_modx_data():
    with (MODX_SOURCE_DIR / "published_resources_flat.json").open("r", encoding="utf-8") as f:
        resources = json.load(f)
        
    with (ROOT / "backend/src/api/page/content-types/page/schema.json").open("r", encoding="utf-8") as f:
