...
- `ButtonLink`, `SectionHeading`, `MediaFrame` — from [components-module.md](components-module.md)
- `PageSection` — layout wrapper with background/rhythm classes
- `CmsHtml` — rich text rendering (used by hero, advantages, promos)

## Related

- [sections-module.md](sections-module.md) — SectionRenderer module
- [components-module.md](components-module.md) — design system primitives
