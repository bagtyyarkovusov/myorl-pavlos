...
DEFAULT_MODX = ROOT / "published_resources_flat.json"
DEFAULT_TRANSFORMED = ROOT / "transformed_resources.json"
DEFAULT_REPORT = ROOT / "slug_parity_report.json"
DEFAULT_OUT = ROOT / "slug_redirects_next.json"
