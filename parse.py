...
def process():
    ...
    resources_raw = extract_insert_values('ce39229_myorl_21_04.sql', 'modx_site_content')
    ...
    tv_vals_raw = extract_insert_values('ce39229_myorl_21_04.sql', 'modx_site_tmplvar_contentvalues')
    ...
    with open('published_resources.json', 'w', encoding='utf-8') as f:
        json.dump(tree, f, ensure_ascii=False, indent=2)
        
    with open('published_resources_flat.json', 'w', encoding='utf-8') as f:
