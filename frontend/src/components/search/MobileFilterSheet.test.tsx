...
describe("MobileFilterSheet", () => {
  it("renders a 'Filters' trigger button", () => {
    render(
      <MobileFilterSheet sections={["Section A"]} locale="el" activeFilterCount={0} />,
    );
  ...
  it("shows filter count in the trigger", () => {
    render(
      <MobileFilterSheet sections={["Section A"]} locale="el" activeFilterCount={2} />,
    );
  ...
  it("renders count in Russian locale", () => {
    render(
      <MobileFilterSheet sections={["Section A"]} locale="ru" activeFilterCount={1} />,
    );
  ...
  it("does not show filter count when 0", () => {
    render(
      <MobileFilterSheet sections={[]} locale="el" activeFilterCount={0} />,
    );
