...
This project is indexed by GitNexus as **gemini-export** (2901 symbols, 4265 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
