...
This project is indexed by GitNexus as **gemini-export** (3049 symbols, 4497 relationships, 125 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
