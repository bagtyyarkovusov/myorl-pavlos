...
This project is indexed by GitNexus as **gemini-export** (3014 symbols, 4437 relationships, 126 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
