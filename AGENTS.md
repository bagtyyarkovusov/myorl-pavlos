...
This project is indexed by GitNexus as **gemini-export** (4522 symbols, 7046 relationships, 172 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
