...
> The Strapi v5 backend exposes three API collections: `page` (CMS pages), `global` (singleton site config), and `tag` (taxonomy). All use factory-generated controllers, services, and routes.
...
See [strapi-components-deep-dive.md](strapi-components-deep-dive.md).

## Related

- [cms-module.md](cms-module.md) — Next.js gateway layer that consumes this API
- [backend-moc.md](backend-moc.md) — backend entry points
