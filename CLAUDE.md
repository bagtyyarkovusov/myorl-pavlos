...
This project is indexed by GitNexus as **gemini-export** (3168 symbols, 4723 relationships, 133 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
