...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide localized chrome (header/footer): address, phone, hours, email, social links.';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    phoneTel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    secondaryPhoneDisplay: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    secondaryPhoneTel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    socialLinks: Schema.Attribute.Component<'items.social-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disclaimerOverride: Schema.Attribute.Enumeration<
      ['default', 'force-show', 'force-hide']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    hideFromMenu: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    imageCenter: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    infoBlockBottom: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    menuIndex: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    popUpClose: Schema.Attribute.RichText &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    relatedPages: Schema.Attribute.Relation<'manyToMany', 'api::page.page'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiUrlMappingUrlMapping extends Struct.CollectionTypeSchema {
  collectionName: 'url_mappings';
  info: {
    description: 'Legacy \u2192 canonical URL redirect pairs';
    displayName: 'URL Mapping';
    pluralName: 'url-mappings';
    singularName: 'url-mapping';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    destinationKind: Schema.Attribute.Enumeration<
      ['internal-301', 'external-301', 'gone-410']
    > &
      Schema.Attribute.Required;
    destinationPath: Schema.Attribute.String & Schema.Attribute.Required;
    legacyPath: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::url-mapping.url-mapping'
    > &
      Schema.Attribute.Private;
...
export interface ApiVideoEntryVideoEntry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Standalone medical video in the site video library';
    displayName: 'Video Entry';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    legacyArticleUrl: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    relatedArticle: Schema.Attribute.Relation<'manyToOne', 'api::page.page'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::url-mapping.url-mapping': ApiUrlMappingUrlMapping;
