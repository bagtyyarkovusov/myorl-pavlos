...
AUDIT_PATH = ROOT / "locale_pair_audit.json"
...
TAG_MAPPING_PATH = ROOT / "tag_mapping.yaml"
REPORT_PATH = ROOT / "injection_readiness.json"
...
def gate_asset(resources: list[dict[str, Any]], asset_map: dict[str, Any]) -> dict[str, Any]:
    ...
    html_allowlist, tv_allowlist = _load_orphan_allowlist(Path(__file__).resolve().parent)
