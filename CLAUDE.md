...
This project is indexed by GitNexus as **gemini-export** (2877 symbols, 4230 relationships, 123 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
