...
source: code reading (backend/src/components/)
---
...
The `shared.seo` component is reused across `page` and `global` content types as a repeatable component for consistent SEO field shapes.
...
- [[backend-api]] — Strapi API architecture
- [[../modules/cms]] — frontend DTO layer
- [[../modules/sections]] — SectionRenderer dispatcher
