...
This project is indexed by GitNexus as **gemini-export** (4406 symbols, 6867 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
