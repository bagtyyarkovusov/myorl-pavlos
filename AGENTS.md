...
This project is indexed by GitNexus as **gemini-export** (4498 symbols, 6909 relationships, 145 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
